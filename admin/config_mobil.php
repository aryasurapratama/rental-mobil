                  ...
                  <tbody>
                    ...
                    if($result){
                      while($obj = $result->fetch_object()) {
                        ...
                        echo 		'<td>'.$obj->jenis_mobil.'</td>';
                        echo 		'<td><img style="width:100px;" src="../asset_gambar/'.$obj->gambar.'"/></td>';
                        if($obj->status==0){
                          echo 		'<td>TERSEDIA</td>
                          <td><a href="backend_admin/dipakai.php?action=add&id='.$obj->id_mobil.'"><em class="fa fa-lg fa-check-circle"></em>Pakai</a></td>';
                        } else {
                          echo 		'<td>DIGUNAKAN</td>
                          <td><a style="color:red;" href="backend_admin/dikembalikan.php?action=add&id='.$obj->id_mobil.'"><em style="color:red;" class="fa fa-lg fa-arrow-left "></em>Kembali</a>
                          </td>';
                        }
                        echo 	'</tr>';
                      }
