                  ...
                  <tbody>
                    ...
                    if($result){
                      while($obj = $result->fetch_object()) {
                        ...
                        echo 		'<td>'.$obj->harga_sewa.'</td>';
                        echo 		'<td><img style="width:100px;" src="../asset_gambar/'.$obj->gambar.'"/></td>';
                        echo 		'<td>
                        <a href="halaman_edit.php?action=add&id='.$obj->id_mobil.'"><em class="fa fa-lg fa-edit"></em></a>
                        </td>';
                        // echo 		'<td>
                        // <a href="hapus.php?action=add&id='.$obj->id_mobil.'"><em class="fa fa-lg fa-trash"></em></a>
                        // </td>';
                        echo 	'</tr>';
                      }
                    }
