  ...
  <div class="wrapper">
    ...
    <div class="sidebar-wrapper">
      ...
      <ul class="nav">
        ...
        <li>
          <a class="nav-link" href="condig_mobil.php">
          ...
          <div class="col-md-8">
            <div class="card ">
              <div class="card-header ">
                <!-- jarak -->
                <form class="" action="backend_admin/insert_data.php" method="post" enctype="multipart/form-data">
                  <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-sm-10">
                      <label for="inputEmail4">JENIS MOBIL</label>
                      <div class="form-row">
                    ...
                    <div class="form-group col-md-10">
                      ...
                      <input type="file" name="fileToUpload" class="form-control" placeholder="Gambar" required>
                    </div>
                    <div class="form-group col-md-12">
                      <center>
