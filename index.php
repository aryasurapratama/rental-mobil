...
<head>
  ...
  <link href="vendor/assets/css/light-bootstrap-dashboard.css?v=2.0.0 " rel="stylesheet" />
    ...
    <div class="  container-fluid ">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="user/index.php">Produk</a>
          </li>
          <li class="nav-item">
    ...
    <div class="page-header clear-filter" filter-color="purple">
      <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/full-screen-image-3.jpg')">
        ...
        <div class="title-container text-center">
          <h1>SEWA KENDARAAN AMAN & TERPERCAYA</h1>
          <!-- <h3>Elements description v2.0.0</h3> -->
          <h4 class="description text-center">RENTAL MOBIL</h4>
          <br />
          <a href="user/register.php" class="btn btn-round btn-neutral btn-fill" target="_blank">DAFTAR AKUN</a>
        </div>
      </div>
    </div>
    <footer class="footer">
      <div class="container-fluid">
        <nav>
          <p class="copyright text-center">
            ...
            <a href="http://www.creative-tim.com">Rental Mobil</a> Rental Mobil
          </p>
        </nav>
      </div>
    </footer>
...
<!--   Core JS Files   -->
<script src="vendor/assets/js/core/jquery.3.2.1.min.js" type="text/javascript"></script>
...
<!--  Chartist Plugin  -->
<script src="vendor/assets/js/plugins/chartist.min.js"></script>
<!--  Notifications Plugin    -->
<script src="vendor/assets/js/plugins/bootstrap-notify.js"></script>
<!-- Control Center for Light Bootstrap Dashboard: scripts for the example pages etc -->
<script src="vendor/assets/js/light-bootstrap-dashboard.js?v=2.0.0 " type="text/javascript"></script>
<!-- Light Bootstrap Dashboard DEMO methods, don't include it in your project! -->
<script src="vendor/assets/js/demo.js"></script>
<script>
var header_height;
var fixed_section;
var floating = false;
