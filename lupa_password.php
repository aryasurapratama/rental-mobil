  ...
  <div class="main-content-wrapper d-flex clearfix">
    ...
    <div class="mobile-nav">
      ...
      <div class="amado-navbar-brand">
        <a href="index.php"><img src="user/img/core-img/logi.png" alt=""></a>
      </div>
      <!-- Navbar Toggler -->
    ...
    <header class="header-area clearfix">
      ...
      <!-- Logo -->
      <div class="logo">
        <a href="index.php"><img style="height:150px;" src="user/img/core-img/logi.png" alt=""></a>
      </div>
      <!-- Amado Nav -->
      <nav class="amado-nav">
        <ul>
          ...
          <?php   if(isset($_SESSION["username"])){
            echo ' <li><a href="user/product.php">Product</a></li>
            <li><a href="user/aksi_pemb.php">Pembayaran</a></li>
            <li><a href="user/detail_sewa.php">Detail Sewa</a></li>
            ...
            <li><a href="user/register.php">Daftar Akun</a></li>
                  ...
                  <form method="POST" action="backend/sendmail.php">
                    <div class="form-row">
                      <div class="form-group col-md-10">
                        <label for="inputEmail4">MASUKAN EMAIL</label>
                        <input  class="form-control" type="email" placeholder="email@gmail.com" name="email" required>
                      </div>
                    </div>
                    <div class="p-t-30">
                      <button class="btn btn-success btn-md" type="submit">Kirim</button>
                    </div>
                    <div class="p-t-20">
                      <p>Belum Memliki Akun? <a href="register.php">Daftar</a></p>
                    </div>
                  </form>
                </div>
              </div>
      ...
      <div class="col-12 col-lg-4">
        <div class="single_widget_area">
          ...
          <div class="footer-logo mr-50">
            <a href="index.html"><img style="margin-left:50px;width:100px" src="user/img/core-img/logi.png" alt=""></a>
          </div>
          <!-- Copywrite Text -->
