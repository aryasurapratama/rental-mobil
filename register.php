      ...
      <nav class="amado-nav">
        <ul>
          ...
          <?php   if(isset($_SESSION["username"])){
            ...
            <li class="active"><a href="user/register.php">Daftar Akun</a></li>
        ...
        <div class="row">
          <div class="col-12 col-lg-8">
            <div class="cart-title mt-50">
              <h2>DAFTAR AKUN RENTAL MOBIL</h2>
            </div>
            <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
              <div class="wrapper wrapper--w960">
                <div class="card card-2">
                  ...
                  <div class="card-body">
                    <!-- <h2 class="title"></h2> -->
                    <form method="POST" action="backend/daftar_akun.php">
                      <div class="form-row">
                      ...
                      <div class="p-t-30">
                        <button class="btn btn-success btn-md" type="submit">DAFTAR</button>
                      </div>
        ...
        <div class="col-12 col-lg-4">
          <div class="single_widget_area">
            ...
            <div class="footer-logo mr-50">
              <a href="index.php"><img style="margin-left:50px;width:100px" src="user/img/core-img/logi.png" alt=""></a>
            </div>
            <!-- Copywrite Text -->
