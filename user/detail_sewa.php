            ...
            <nav class="amado-nav">
              <ul>
                ...
                <?php   if(isset($_SESSION["username"])){
                  ...
                  <li class="active"><a href="detail_sewa.php">Detail Sewa</a></li>
                    ...
                    <div class="cart-title mt-100">
                      ...
                      <table class="table table-responsive">
                        ...
                        <tbody>
                          ...
                          $result = $mysqli->query("SELECT * FROM tb_detail_sewa as ds INNER JOIN tb_sewa as s ON s.id_sewa=ds.id_sewa INNER JOIN mobil as m ON m.id_mobil=s.id_mobil INNER JOIN user as us ON us.id_user=s.id_user INNER JOIN pembayaran as pm ON ds.id_detail_sewa=pm.id_detail_sewa WHERE s.id_user='$id_user' AND ds.waktu_penggunaan!='0000-00-00'");
                          $i = 1;
                          if($result === FALSE){
                            die(mysql_error());
                          }
